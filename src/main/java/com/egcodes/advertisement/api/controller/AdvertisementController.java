...
public class AdvertisementController {
    ...
    public ResponseEntity<AdvertisementDTO> add(@Valid @RequestBody AdvertisementDTO dto) {
        return ResponseEntity.ok(advertisementMapper.toDTO(advertisementCommandService.add(advertisementMapper.toEntity(dto))));
    }
